          ...
          <div className="flex flex-wrap gap-3 mb-4">
            {images.map((img, i) => (
              <img
                ...
                className="w-40 h-28 rounded-xl object-cover border border-white/10 hover:border-indigo-500/40 cursor-zoom-in hover:scale-102 hover:shadow-[0_0_15px_rgba(99,102,241,0.12)] transition-all duration-200"
              />
            ))}
          </div>
        )}<ReactMarkdown
